...
Leaflet-first dashboard that visualizes global signals on a world map. Includes live USGS earthquakes plus real data hookups for flights (OpenSky) and weather (Open-Meteo/OpenWeather).
...
- `app.js` — Leaflet map, live USGS earthquakes, OpenSky flights, Open-Meteo/OpenWeather current weather, layer toggles (including cluster/heat), timeline filtering, dark basemap switch.
